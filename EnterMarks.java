...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    EnterMarks(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("course/m.jpg"));
        ...
        lblentersubject.setFont(new Font("serif", Font.PLAIN, 16));
        add(lblentersubject);
        
        JLabel lblentermarks = new JLabel("Enter Marks");
        lblentermarks.setBounds(320, 150, 200, 40);
        lblentermarks.setFont(new Font("serif", Font.PLAIN, 16));
        add(lblentermarks);
