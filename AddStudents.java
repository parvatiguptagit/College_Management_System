...
public class AddStudents extends JFrame implements ActionListener{
    ...
    AddStudents(){
        ...
        lblrollno.setFont(new Font("sarif", Font.BOLD, 18));
        add(lblrollno);
        
        labelrollno = new JLabel("2602"+first4);
        labelrollno.setBounds(200, 200, 200, 30);
        labelrollno.setFont(new Font("sarif", Font.BOLD, 18));
        add(labelrollno);
        ...
        String course[] = {"B.Tech", "BSC", "BCA", "BE", "MSC", "MCA", "MBA"};
